...
const Dashboard = () => {
  ...
  <div className="donut-card">
    <div className="semi-arc">
      <svg width="220" height="110" viewBox="0 0 220 110">
        <path d="M20,100 A90,90 0 0,1 90,20" stroke="#CB3CFF" strokeWidth="10" fill="none" />
        <path d="M90,20 A90,90 0 0,1 130,20" stroke="#0038FF" strokeWidth="10" fill="none" />
        <path d="M130,20 A90,90 0 0,1 200,100" stroke="#00C2FF" strokeWidth="10" fill="none" />
      </svg>
    ...
    <br></br>
        <br></br>
      <li><span className="dot purple"></span>Desktop users <span className="count">4,100</span></li>
      <br></br>
      <li><span className="dot blue"></span>Phone app users <span className="count">643</span></li>
      <br></br>
      <li><span className="dot green"></span>Laptop users <span className="count">1,000</span></li>
    </ul>
  </div>
  ...
  <div className="recent-table">
    ...
    <table>
      ...
      <tbody>
        <tr><td>John Parker</td><td>May 30, 9:38 AM</td><td>Premium</td><td>$499</td></tr>
        <tr><td>Christiano</td><td>Dec 29, 4:38 AM</td><td>Startup</td><td>$89</td></tr>
        <tr><td>Paul</td><td>Dec 28, 12:38 AM</td><td>Basic</td><td>$100</td></tr>
        <tr><td>Abdullah</td><td>Dec 28, 2:29 PM</td><td>Standard</td><td>$200</td></tr>
        <tr><td>John Wick</td><td>Dec 26, 9:04 AM</td><td>Standard</td><td>$200</td></tr>

        <tr><td>Emily Rose</td><td>Dec 25, 11:00 AM</td><td>Premium</td><td>$499</td></tr>
      </tbody>
    </table>
  </div>
</div>
...
<div className="map-section">
  <div className="country-stats">
    ...
    <ul className="country-list">
      <li><span className="bar us"></span> United States - 30%</li>
      <li><span className="bar uk"></span> United Kingdom - 25%</li>
      <li><span className="bar ca"></span> Canada - 25%</li>
      <li><span className="bar au"></span> Australia - 10%</li>
      <li><span className="bar es"></span> Spain - 10%</li>
    </ul>
  </div>
  ...
  <div className="dot-map-container">
      ...
      <div className="glow-dot" style={{ top: "28%", left: "26%", backgroundColor: "#CB3CFF" }}></div> {/* US */}
      <div className="glow-dot" style={{ top: "24%", left: "42%", backgroundColor: "#A3B1FF" }}></div> {/* UK */}
      <div className="glow-dot" style={{ top: "30%", left: "46%", backgroundColor: "#FFFFFF" }}></div> {/* Europe */}
      <div className="glow-dot" style={{ top: "42%", left: "55%", backgroundColor: "#A3B1FF" }}></div> {/* India */}
      <div className="glow-dot" style={{ top: "66%", left: "77%", backgroundColor: "#00C2FF" }}></div> {/* Australia */}
    </div>
</div>
